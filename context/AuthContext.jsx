...
var AuthProvider = exports.AuthProvider = function AuthProvider(_ref) {
  ...
  (0, _react.useEffect)(function () {
    var checkAuth = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var savedToken, parsedToken, userData, _t;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            ...
            case 1:
              // Parse token
              parsedToken = (0, _auth.parseToken)(savedToken);
              if (parsedToken) {
                _context.n = 2;
                break;
              }
            ...
            case 2:
              // Get user data
              userData = (0, _localStorage.getUserById)(parsedToken.userId);
              if (userData) {
                _context.n = 3;
                break;
              }
  ...
  var logout = function logout() {
    ...
    if (authState.user) {
      (0, _localStorage.removeToken)(authState.user.id);
    }
  ...
  return /*#__PURE__*/_react["default"].createElement(AuthContext.Provider, {
    value: _objectSpread(_objectSpread({}, authState), {}, {
      login: login,
      logout: logout
    })
  }, children);
