...
var RegisterForm = exports.RegisterForm = function RegisterForm() {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          ...
          case 3:
            ...
            setError(null);
            _context.p = 4;
            result = (0, _auth.registerUser)(name, email, password);
            if (!('error' in result)) {
              _context.n = 5;
              break;
            }
  ...
  return /*#__PURE__*/_react["default"].createElement("form", {
    ...
    leftIcon: /*#__PURE__*/_react["default"].createElement(_lucideReact.User, {
